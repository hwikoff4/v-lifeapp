                        ...
                        <CardContent className="p-0">
                          ...
                          {expandedExercise === exercise.id && (
                            <div className="border-t border-white/10 p-4">
                              <div className="mb-4 aspect-video rounded-lg bg-black/70 flex items-center justify-center">
                                <img
                                  src={`/abstract-geometric-shapes.png?height=200&width=300&query=${exercise.name} exercise demonstration`}
                        ...
                        <CardContent className="p-0">
                          ...
                          {expandedExercise === exercise.id && (
                            <div className="border-t border-white/10 p-4">
                              <div className="mb-4 aspect-video rounded-lg bg-black/70 flex items-center justify-center">
                                <img
                                  src={`/abstract-geometric-shapes.png?height=200&width=300&query=${exercise.name} cardio exercise`}
                                  alt={`${exercise.name} demonstration`}
                                  className="h-full w-full rounded object-cover"
                                />
                              </div>
